...
//
//	mockgen.exe -package webtransport -destination mock_stream_test.go github.com/TugasAkhir-QUIC/quic-go Stream
//
...
func (mr *MockStreamMockRecorder) SetPriority(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
