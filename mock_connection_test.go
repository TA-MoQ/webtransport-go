...
// Source: github.com/TA-MoQ/quic-go (interfaces: Connection)
//
// Generated by this command:
//
//	mockgen.exe -package webtransport -destination mock_connection_test.go github.com/TA-MoQ/quic-go Connection
//
